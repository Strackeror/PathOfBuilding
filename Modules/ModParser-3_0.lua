...
local modTagList = {
	...
	["for each summoned golem"] = { tag = { type = "Multiplier", var = "SummonedGolems" } },
	["for each golem you have summoned"] = { tag = { type = "Multiplier", var = "SummonedGolems" } },
	-- Per stat
...
local specialModList = {
	...
	["shocks from your hits always increase damage taken by at least (%d+)%%"] = function(num) return { mod("EnemyShockEffect", "OVERRIDE", num) } end,
